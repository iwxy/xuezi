...
<!--订单确认-->
<form action="../web/pay_success.jsp" method="post" id="pay_form">
    <div id="container" class="clearfix" >
        ...
        <!--     剩余付款时间：<b>15：00</b> -->
            ...
            <span class="okPay"><a href="../web/pay_success.jsp">确认支付</a></span>
...
<script>
	$(".okPay").click(function(){
		window.location.href="../web/pay_success.jsp";
    })
</script>
<script>
