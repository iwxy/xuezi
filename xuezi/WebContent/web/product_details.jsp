...
<!--细节导航-->
<div id="nav_detail">
    <h5><a href="../main/showIndex.jsp">首页 ></a><a href=""> 华硕电脑 ></a> <a>联想 ></a></h5>
</div>
<!--产品预览-->
<div id="shop_detail">
    <!-- 左侧-->
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="<c:url value='/images/goodstore/${goods.goodsImage[0] }'></c:url>" width=450px height=353px/>
        </div>
        
        <div id="icon_all">
        	<ul id="icon_list">
        		<c:forEach items="${goods.goodsImage }" var="goodsImage">
                 	<li class="i1"><img src="<c:url value='/images/goodstore/${goodsImage }'></c:url>" width=75px height=80px/></li>
                </c:forEach>
            </ul>
    ...
    <div class="right_detail lf">
        ...
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>学员售价：</b><span>￥${goods.goodsMoney }</span></div>
            <div class="promise">
                <b>服务承诺：</b>
                <span>*退货补运费</span>
                <span>*30天无忧退货</span>
        ...
        <p class="style" id="choose_color">
            <s class="color">颜色：</s>
            <c:forEach var="color" items="${goods.goodsColor }">
            	 <input type="button" class="i1" value="${color}" title="${color }"/>
            </c:forEach>
        </p>
        <!-- 规格-->
        <p>
            <s>规格：</s>
            <c:forEach var="standard" items="${goods.goodsStandard }">
            	<span class="avenge">${standard }</span>
            </c:forEach>
    ...
    <div class="left lf">
        <div class="all">
            ...
            <div id="parm">
                ...
                <ul>
                    <li><a href="#">商品名称：${goods.goodsName}</a></li>
                    <li><a href="#">系统：${goods.goodsSystem}</a></li>
                    <li><a href="#">内存容量：${goods.goodsStorage }</a></li>
                    <li><a href="#">分辨率：${goods.goodsResolution }</a></li>
                    <li><a href="#">显卡型号：${goods.goodsGraphics }</a></li>
                    <li><a href="#">处理器：${goods.goodsProcessor }</a></li>
                    <li><a href="#">显存容量：${goods.goodsDisplaystorage }</a></li>
                    <li><a href="#">分类：${goods.goodsType }</a></li>
                    <li><a href="#">硬盘容量:${goods.goodsDisk }</a></li>
                </ul>
            </div>
            ...
            <div id="packing_list">
                ...
                <p class="content"> ${goods.goodsPack}</p>
            </div>
        </div>
    </div>
    <div class="right rt">
...
<script type="text/javascript">
    ...
    $("#add_cart").click(function (e) {
    	...
    	location.href='../cart/insertCart.do?goodsId=${goods.goodsId }&goodsMoney=${goods.goodsMoney}&goodsNum='+buyAccount;
        e.preventDefault();
        getPro();
        var params = {
            itemColor: color,
    ...
    $('.yes').click(function(){
        $('.modal').hide();
        location.href='../favorites/insertFavorites.do?goodsId=${goods.goodsId }';
    })
</script>
<script>
    $(function () {
        ...
        $("#buy_now").click(function (e) {
           ...
           e.preventDefault();
            ...
            location.href="../order/addGoodsOrder.do?goodsId="+goodsId+"&goodsColor="+color+"&goodsNum="+num;
            // 后台需要的参数
