...
<div class="ck-slide">
    <ul class="ck-slide-wrapper">
        <li>
            <a href="../goods/product_details.do?goodsId=1"><img src="../images/itemCat/itemCat_banner1.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="../goods/product_details.do?goodsId=2"><img src="../images/itemCat/itemCat_banner2.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="../goods/product_details.do?goodsId=6"><img src="../images/itemCat/itemCat_banner3.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="../goods/product_details.do?goodsId=7"><img src="../images/itemCat/itemCat_banner4.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="../goods/product_details.do?goodsId=8"><img src="../images/itemCat/itemCat_banner1.png" alt=""></a>
        </li>
    </ul>
    ...
    <div class="lf1_top">
        ...
        <div class="left lf">
            <div class="left_pro lf">
                ...
                <p class="top_ys4 color_2"><a href="../goods/product_details.do?goodsId=1"><a href="../goods/product_details.do?goodsId=4">查看详情</a></a></p>
            </div>
        ...
        <div class="right lf">
            <div class="right_pro lf">
                ...
                <p class="top_ys4 color_2"><a href="../images/itemCat/study_computer_img2.png"><a href="../goods/product_details.do?goodsId=5">查看详情</a></a></p>
            </div>
    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
                <p>华硕电脑整机</p>
                <ul>
                    <li><a href="../goods/selectGoodsByType.do?goodsType=1">华硕笔记本</a></li>
                    <li><a href="../goods/selectGoodsByType.do?goodsType=2">华硕游戏机</a></li>
                    <li><a href="../goods/selectGoodsByType.do?goodsType=3">华硕台式机</a></li>
                 </ul>
                <p>联想电脑整机</p>
                <ul>
                    <li><a href="../goods/selectGoodsByType.do?goodsType=4">华硕笔记本</a></li>
                    <li><a href="../goods/selectGoodsByType.do?goodsType=5">华硕台式机</a></li>
                    <li><a href="../goods/selectGoodsByType.do?goodsType=6">华硕家庭机</a></li>
                </ul>
            </div>
        </div>
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_2"><a href="../goods/product_details.do?goodsId=6">查看详情</a></p>
        </div>
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_2"><a href="../goods/product_details.do?goodsId=3">查看详情</a></p>
        </div>
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_2"><a href="../goods/product_details.do?goodsId=9">查看详情</a></p>
        </div>
    </div>
</div>
<!--楼梯2f-->
    ...
    <div class="lf1_top">
        ...
        <div class="left lf">
            ...
            <div class="left_pro lf">
                ...
                <p class="top_ys4 color_1"><a href="../goods/product_details.do?goodsId=10">查看详情</a></p>
            </div>
        </div>
        <!-- 上面部分右侧区域-->
        <div class="right lf">
            ...
            <div class="right_ys rt">
                ...
                <p class="top_ys4 color_1"><a href="../goods/product_details.do?goodsId=11">查看详情</a></p>
            </div>
        </div>
    </div>
    <div class="lf1_bottom">
        ...
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_1"><a href="../goods/product_details.do?goodsId=12">查看详情</a></p>
        </div>
        <div class="item_msg lf">
            ...
            <p class="bottom_ys4 color_1"><a href="../goods/product_details.do?goodsId=14">查看详情</a></p>
        </div>

        <div class="item_msg lf">
            <a href="../goods/product_details.do?goodsId=1">
            ...
            <p class="bottom_ys4 color_1"><a href="../goods/product_details.do?goodsId=4" id="iii">查看详情</a></p>
            </a>
        </div>
